"""
Simple script to populate Supabase with sample data using direct HTTP requests.
This avoids the Supabase client compatibility issues.
"""
...
# Sample responses data (first 20 for testing)
RESPONSES_DATA = [
...
def create_table_via_sql(table_sql):
...
def main():
    print("Impact Intelligence Platform - Simple Data Population")
    print("=" * 60)
    ...
    if create_table_via_sql(vector_sql):
        print("✅ pgvector extension enabled")
    else:
        print("⚠️  Could not enable pgvector extension")
    ...
    if create_table_via_sql(questions_sql):
        print("✅ Questions table created")
    else:
        print("⚠️  Could not create questions table")
    ...
    if create_table_via_sql(responses_sql):
        print("✅ Responses table created")
    else:
        print("⚠️  Could not create responses table")
