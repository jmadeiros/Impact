...
Migrated from working_server.py with updated imports
"""
...
app = FastAPI(
    title="Impact Intelligence Platform - Simple System",
...
async def health_check():
    ...
    return {"status": "healthy", "service": "Impact Intelligence Platform - Simple System"}

@app.get("/")
async def root():
    """Root endpoint with usage instructions"""
    return {
        "message": "Impact Intelligence Platform API - Simple System",
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 Starting Impact Intelligence Platform - Simple System")
